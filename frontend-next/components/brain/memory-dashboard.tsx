...
import type { MemoryEvent, GraphNode, GraphEdge } from "@/lib/use-memory-engine";
...
export function MemoryDashboard({
  ...
  return (
    <div className="flex flex-col h-full bg-[#0A0E1A]">
      {/* Event Stream — 40% */}
      <div className="h-[40%] border-b border-[#1F2937]">
        <EventStream events={events} />
      </div>

      {/* Temporal Graph — 35% */}
      <div className="h-[35%] border-b border-[#1F2937]">
        <TemporalGraph
          nodes={nodes}
          edges={edges}
